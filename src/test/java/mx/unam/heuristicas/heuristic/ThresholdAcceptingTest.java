...
class ThresholdAcceptingTest {
        ...
        @Test
        void shouldKeepBestSolutionFoundInIncompleteBatch() {
                for (int i = 0; i < 20; i++) {

                        ObjectiveFunction<Double> objectiveFunction = solution -> solution;

                        Neighborhood<Double> neighborhood = new Neighborhood<>() {
